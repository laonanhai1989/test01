...
<div class="main">
  <div class="huanying">
		<p style="font-size:24px;color:#0066FF">登录失败！</p>
		<br>
		<form method="post">
		<p style="font-size:xx-large">产生错误的可能原因：</p> 
		</form>
  </div>
  <div class="tiaozhuan">
<p  align="center"style="font-size:18px">用户名、密码不匹配如果您还没有注册，请注册成为会员，方可登录</p>
<p  align="center"style="font-size:12px">返回<a href="dl.php">登录</a>界面</p>
  </div>
</div>
